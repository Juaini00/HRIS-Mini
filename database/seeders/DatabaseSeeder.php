...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ($accounts as $account) {
            ...
            $employee = $user->employee()->updateOrCreate([], ['employee_number' => $account['number'], 'department_id' => $account['department']->id, 'position_id' => $account['position']->id, 'location_id' => $location->id, 'joined_at' => now()->subYear(), 'basic_salary' => $account['salary']]);
