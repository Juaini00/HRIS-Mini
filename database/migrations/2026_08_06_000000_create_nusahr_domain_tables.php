...
return new class extends Migration
{
    ...
    {
        foreach (['settings', 'audit_logs', 'employee_documents', 'announcements', 'payroll_records', 'payroll_periods', 'attendances', 'leave_requests', 'leave_balances', 'holidays', 'leave_types', 'employees', 'locations', 'positions', 'departments'] as $table) {
